<?php
interface cfg {
	const db_host = 'server.com';
	//database password
	const db_pass = 'somepassword';
	//database user
	const db_user = 'someuser';
	//database name
	...
	//encryption key [v3] - SECRET
	const ENC_KEY = '\01\29\0F\21\11\17\27\'; # replace this encryption key with your own.
}
